...
SiftJob* process_image(const string& inputFile, PopSift& PopSift)
{
    ...
    if(!pgmread_loading)
    {
        ...
        // return job; // returned once for both pgm and devIL
...
int main(int argc, char** argv)
{
    ...
    PopSift PopSift(config, popsift::Config::ExtractingMode, float_mode ? PopSift::FloatImages : PopSift::ByteImages);
