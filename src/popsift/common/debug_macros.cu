...
namespace popsift {
namespace cuda {
// What is the point of file and line they don't seem to be used unless I minunderstand how __LINE__ and __FILE__
// works as they would just use where they where called not the passed file and line argumetns here so they are
// never used
void malloc_dev(void** ptr, int sz, const char* file, int line)
{
    cudaError_t err;
...
namespace popsift {
namespace cuda {
void malloc_hst(void** ptr, int sz, const char* file, int line)
{
    cudaError_t err;
...
namespace popsift {
namespace cuda {
void malloc_mgd(void** ptr, int sz, const char* file, int line)
{
    cudaError_t err;
...
namespace cuda {
void memcpy_async(
  void* dst, const void* src, size_t sz, cudaMemcpyKind type, cudaStream_t stream, const char* file, size_t line)
{
